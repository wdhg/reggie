...
alex_table = listArray (0 :: Int, 265)
  [ 0
  , 6
  , 6
  , 6
...
alex_check = listArray (0 :: Int, 265)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 =  \s -> checkWhitespace s 
alex_action_1 =  \s -> TokenRegister $ read $ drop 1 s 
alex_action_2 =  \s -> TokenLabel $ read $ drop 1 s 
alex_action_3 =  \s -> TokenArrow 
alex_action_4 =  \s -> TokenHalt 
alex_action_5 =  \s -> TokenIncr 
alex_action_6 =  \s -> TokenDecr 
alex_action_7 =  \s -> TokenHalt 
